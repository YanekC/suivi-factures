...
export default function KeySetup(props: Props) {
    ...
    function handleTokenValidation() {
        ...
        validateToken({ id: props.secretId, key: props.secretKey }).then(generatedToken => {
    ...
    return (
        <>
            ...
            <Link href="https://actualbudget.org/docs/advanced/bank-sync/gocardless">
                <Text>Pour récupérer votre token, suivez les étapes ici : https://actualbudget.org/docs/advanced/bank-sync/gocardless</Text>
            </Link>
            <Text>Secret Id</Text>
            <TextInput multiline style={styles.input} onChangeText={(value) => { props.setSecretId(value); SecureStore.setItemAsync("secret_id", value) }} value={props.secretId} />
            <Text>Secret Key</Text>
            <TextInput multiline style={[styles.input, { height: 100 }]} onChangeText={(value) => { props.setSecretKey(value); SecureStore.setItemAsync("secret_key", value) }} value={props.secretKey} />
